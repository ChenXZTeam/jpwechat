...
function ajax(title){
		...
		$.ajax({
			url:"<%=basePath %>framework/info/findInfoByTitle.action",
			type:"POST",
			data:{"title":title},
			dataType:"json",
			success:function(data){
				...
				if(data.msg==1){
					...
					//$("#bigTable").append("<tr class='cententTR'><td class='cententTD'>"+getInfo[0].title+"</td></tr><tr class='cententTR'><td class='cententTD1'>"+getInfo[0].introduction+"</td></tr><div class='heng'></div><tr class='cententTR'><td class='cententTD'>"+getInfo[0].info+"</td></tr>");
