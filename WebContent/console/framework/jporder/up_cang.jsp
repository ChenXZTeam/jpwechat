...
<style>
	...
	#conditionId div{float:left; margin-left:10px;}
...
<body>
	<div id="conditionId" style="border:1px solid #e1e1e1; padding:10px 8px;">
		<div>
			<select style="width:70px;" disabled="disabled">
			...
			if(orderNum!=null||orderNum!="null"||orderNum!=""){
				$.ajax({
					...
					success: function(result) {
						...
						$("#chufCityPlane").text(dataList.qishiPlane);
						$("#daodCityPlane").text(dataList.daodPlane);
						$("#canbin").val(dataList.cabin);
						...
						$("#chufPlanCode").val(dataList.qishiPlaneCode);
						$("#daodPlanCode").val(dataList.daodPlaneCode);
					},error:function(){
